...
config = {
    "dataset_path": "/home/i53/student/kyang/ET-SEED/log/demo/rotate_triangle/50_rotate_triangle.npy",  # Replace it with your file path.
    "save_path": "log",
...
def prepare_model_input(nxyz, nrgb, noisy_actions, k, num_point):
    ...
    print(nrgb.shape,noisy_actions.shape,tensor_k.shape)
        ...
        for epoch_idx in tglobal:
            ...
            with tqdm(train_dataloader, desc='Batch', position=1, leave=False) as tepoch:
                for nbatch in tepoch:
                    print(nbatch.keys())
                    for key in nbatch.keys():
                        print(nbatch[key].shape)
