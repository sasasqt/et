...
door_asset_file = "8867/mobility.urdf"
...
# Attractors setup
kuka_attractors = ["panda_hand"]  # , "thumb_link_3", "index_link_3", "middle_link_3", "ring_link_3"]
...
for i in range(num_envs):
    ...
    kuka_handle = gym.create_actor(env, kuka_asset, franka_pose, "kuka", i, 1)
